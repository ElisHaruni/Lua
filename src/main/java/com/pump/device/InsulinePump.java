...
/**
 * This class represents a pump for insulin.
 * 
 * @author Raul Bertone
 */
public class InsulinePump extends AbstractPump {

	public InsulinePump(Reservoir res) {
		super(res);
	}
	...
	public void pump(Dose dose) {
		 ...
		 */
		instance.inject(new Dose(Substances.INSULIN, amount)); 
	}
}
